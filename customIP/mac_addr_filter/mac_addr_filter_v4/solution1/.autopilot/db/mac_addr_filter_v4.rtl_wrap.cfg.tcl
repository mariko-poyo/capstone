...
set DataType0 [list "eth_axis" "struct eth_axis" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType2 [list "eth_axis" "struct eth_axis" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
set Port2 [list $PortName2 $Interface2 $DataType2 $Pointer2 $Dims2 $Const2 $Volatile2 $ArrayOpt2]
lappend PortList $Port2
set PortName3 "src_mac_addr"
set BitWidth3 "64"
set ArrayOpt3 ""
set Const3 "1"
set Volatile3 "0"
...
set Dims3 [list 0]
set Interface3 "wire"
set DataType3 "[list ap_uint 48 ]"
set Port3 [list $PortName3 $Interface3 $DataType3 $Pointer3 $Dims3 $Const3 $Volatile3 $ArrayOpt3]
lappend PortList $Port3
set PortName4 "debug_bit"
set BitWidth4 "8"
set ArrayOpt4 ""
set Const4 "1"
set Volatile4 "0"
